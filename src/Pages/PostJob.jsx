...
import { useNavigate } from 'react-router-dom'; //8.navigation instead of link tag
      ...
      <form onSubmit={handleSubmit}>
        ...
        >
          ...
          <FormControl sx={{ m: 0, width: '100%' }}>
            ...
            >
              {names.map((name) => (
                <MenuItem key={name} value={name} style={getStyles(name, workplaceType, theme)}>
                  {name}
                </MenuItem>
              ))}
            </Select>
          ...
          <FormControl sx={{ m: 0, width: '100%' }}>
            ...
            >
              {namesss.map((name) => (
                <MenuItem key={name} value={name} style={getStyles(name, experienceLevel, theme)}>
                  {name}
                </MenuItem>
              ))}
            </Select>
